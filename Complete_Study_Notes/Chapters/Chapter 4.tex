...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/Chapter 4/homogeneous_vs_inhomogeneous.jpg}
    \caption{Homogeneous vs. Inhomogeneous Saturation: Graphical proof that an inhomogeneously broadened gain medium exhibits far stiffer resistance to saturation, scaling strictly with the square root.}
\end{figure}
...
The Lamb dip is not merely a curiosity. Because it is extremely narrow and occurs precisely at the atomic resonance $\nu_0$, it is exploited constructively in \textbf{saturated-absorption spectroscopy}: locking a laser to the centre of the Lamb dip provides sub-Doppler frequency stabilisation far more precise than is achievable by sitting at the broad Doppler gain peak.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/Chapter 4/gain_saturation_curve.jpg}
    \caption{Steady-State Saturation: Visualising the inevitable collapse of the small-signal gain curve down to exactly match the fixed horizontal loss line $\alpha_r$ as the intracavity flux $\Phi$ builds up.}
\end{figure}
