...
\begin{equation*}
    \frac{\Phi(z + \Delta z) - \Phi(z)}{\Delta z} = \sigma(\nu)\,(N_2 - N_1)\,\Phi \quad \xrightarrow{\Delta z \to 0} \quad \frac{d\Phi}{dz} = \sigma(\nu)\,(N_2 - N_1)\,\Phi
\end{equation*}
