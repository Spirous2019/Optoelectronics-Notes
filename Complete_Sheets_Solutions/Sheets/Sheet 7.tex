...
(d) Mention two advantages of a double-heterostructure laser compared to a single-heterojunction laser?\par\vspace{2cm}
\end{question}
...
(b) Use the figure shown (which plots the refractive index of the active layer versus photon energy at different $y$ in steps of 0.1) to find the thickness of the active layer that maximizes optical confinement under single-mode condition.\par\vspace{2cm}
\end{question}
