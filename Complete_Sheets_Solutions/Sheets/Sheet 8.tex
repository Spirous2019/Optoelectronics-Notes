...
\begin{wrapfigure}{r}{0.35\linewidth}
  \centering
  \includegraphics[width=\linewidth]{../Figures/Sheet 8/q6.jpg}
\end{wrapfigure}
The refractive index of a silicon photodetector is 3.5. Under reverse bias the width of the depletion region is 10 \si{\micro\meter} while the thickness of the material through which the light must pass before reaching the depletion region is 5\si{\micro\meter}. Light of free-space wavelength 0.8 \si{\micro\meter} is incident from air on the photodetector with a power of 1.5 \si{\micro\watt}. The absorption coefficient of this light inside the photodetector is 800 cm$^{-1}$.\\[1ex]
(a) Sketch the distribution of the light power along the depth of penetration inside the photodetector starting from air.\\
(b) Calculate the following (1) The quantum efficiency, (2) The maximum detectable wavelength if the energy gap of silicon is 1.11 eV. (3) The responsivity. (4) The photocurrent.\par\vspace{2cm}
\end{question}
