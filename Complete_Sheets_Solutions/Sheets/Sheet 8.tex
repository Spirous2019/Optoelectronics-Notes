...
(c) The responsivity.\\
(d) The photocurrent when the incident power is 1.5 \si{\micro\watt}.\rule{0pt}{4cm}
\end{question}
...
(b) Calculate the following (1) The quantum efficiency, (2) The maximum detectable wavelength if the energy gap of silicon is 1.11 eV. (3) The responsivity. (4) The photocurrent.\rule{0pt}{4cm}
\end{question}
